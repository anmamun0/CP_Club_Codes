...
ll query(int node, int l, int r, int start, int end)
{
    ...
    ll left = query(leftNode, l, mid, start, end);
    ll right = query(rightNode, mid + 1, r, start, end);
    return left + right;
}
...
{
  /* _Coder   : anmamun0
     _Created : 06 September 2024 ||  21:52:22
     _File    : A_Segment_Tree_for_the_Sum.cpp 
