...
bool solve(int n, int m, int k, str s)
{
    int last = m - 1;
    ...
    { 
        ...
        case 'C': if (last <= 0) return false;
            break;
        }
        
        if(!isPlus(k)) return false;
        last--;
    }
    return true;
}
...
{
  /* _Coder   : anmamun0
     _Created : 11 July 2024 ||  22:05:59
     _File    : D_Test_of_Love.cpp 
