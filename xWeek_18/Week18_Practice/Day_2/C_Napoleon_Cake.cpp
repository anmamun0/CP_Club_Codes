...
{
  /* _Coder   : anmamun0
     _Created : 23 September 2024 ||  01:12:21
     _File    : C_Napoleon_Cake.cpp 
    ...
    testCase
    {
        ...
        for(int i = 0; i<n; i++)
        {
            ...
            if(x>0) fill(lays.begin() + l, lays.begin() + i + 1, true); 

        }   
        for(auto c:lays)  cout << (c ? 1 : 0)<< " "; 
        __stop;
    }
