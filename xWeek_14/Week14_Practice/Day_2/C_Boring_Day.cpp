...
{
  /* _Coder   : anmamun0
     _Created : 25 August 2024 ||  23:02:16
     _File    : C_Boring_Day.cpp 
    ...
    Public
    {
        ll n,l,r; input(n,l,r);
        vector<ll> v(n); input(v);
  

        ll reserve = 0, cnt = 0, j = 0;
        ...
        { 
            ...
            else if (reserve >= l and reserve <= r) 
            { 
                cnt++;
                reserve = 0; 
            } 
        ...
        if (reserve >= l and reserve <= r) cnt++; 
        cout << cnt<<endl;
    }
